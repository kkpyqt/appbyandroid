...
//        看看接口
//        filterChainDefinitionMap.put("contract/conHuman/**", "anon");//JVxeTable无痕刷新示例
//        filterChainDefinitionMap.put("/download/androidapp/**", "anon");//app 下载

        //上传测试数据曲线验证
        filterChainDefinitionMap.put("/health/measure/hmMeasureInfo/addBySet", "anon");
//        版本检测与下载升级
        filterChainDefinitionMap.put("/getlastversion/updatejson/**", "anon");

        filterChainDefinitionMap.put("/download/androidapp/**", "anon");

        filterChainDefinitionMap.put("/sys/phoneLogin2", "anon");//APP手机登录
