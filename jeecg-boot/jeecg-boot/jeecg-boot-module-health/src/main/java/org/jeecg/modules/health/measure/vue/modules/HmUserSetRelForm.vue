    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="厂家名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="bandName">
              <a-input v-model="model.bandName" placeholder="请输入厂家名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="设备类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="deviceName">
              <a-input v-model="model.deviceName" placeholder="请输入设备类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/health.measure/hmUserSetRel/add",
          edit: "/health.measure/hmUserSetRel/edit",
          queryById: "/health.measure/hmUserSetRel/queryById"
        }
      }
    },
    computed: {
