        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="创建日期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="createTime">
              <j-date placeholder="请选择创建日期" v-model="model.createTime"  style="width: 100%" disabled/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="测量值" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="value">
              <a-input v-model="model.mvalue" placeholder="请输入测量值"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="测量单位" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="unit">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/health/measure/hmMeasureInfo/add",
          edit: "/health/measure/hmMeasureInfo/edit",
          queryById: "/health/measure/hmMeasureInfo/queryById"
        }
      }
    },
    computed: {
